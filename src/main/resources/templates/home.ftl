					...
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						 <ul class="nav navbar-nav">
							<li class="hvr-bounce-to-bottom active"><a href="home.ftl">Home</a></li>
				...
				<ul id="flexiselDemo1">			
					<li>
						<div class="banner-bottom-grid">
							...
							<div class="more">
								<a href="single.ftl" class="hvr-bounce-to-bottom sint">Read More</a>
							</div>
						</div>
					</li>
					<li>
			...
			<div class="blog">
				<div class="blog-left">
					<div class="blog-left-grid">
						...
						<div class="clearfix"> </div>
						<a href="single.ftl"><img src="images/4.jpg" alt=" " class="img-responsive" /></a>
